...
| `--harmonise`                          | off                        | Harmonise to 1 arcmin. For GFM (classified) re-encodes float32→uint8 on the same grid (no resampling). For GFM (native) NN-reprojects uint8 codes to 1-arcmin.                                                                                           |
