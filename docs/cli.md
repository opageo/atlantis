...
| `--plot-dir`                           | `<output>/<source>/plots/` | Directory for PNG output. Non-harmonised previews are saved under `processed/`; `--harmonise` previews under `harmonised/` (filenames unchanged).                                                                                               |
