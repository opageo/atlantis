...
| ----------------- | ------- | ------ | ---------------------------- | ---------- | ----------- | ------------------------------------------------------------------------------------------------------ |
| `water_fraction`  | float32 | None   | `water_count`, `valid_count` | average    | nanmean     | Fraction of valid SAR observations flagged as water (water_count / valid_count); NaN where unobserved. |
...
| `reference_water` | uint8   | 255    | `reference_water_codes`      | nearest    | max         | Reference-water codes carried through from GFM reference_water_mask under the shared layer name.       |
