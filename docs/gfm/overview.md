...
**seasonal hydrology**. It is a **static** baseline produced once by the GFM
service over a fixed **5-year reference period covering 2017–2021** (Sentinel-1
A and B), generated by applying an ensemble water mapping workflow (LIST + DLR)
over the multi-year stack of SAR imagery:
